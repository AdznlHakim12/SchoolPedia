            ...
            <div class="bg-yellow-300 w-4/5 p-4 rounded-lg">
                <div class="flex">
                    <div class="w-1/3 p-4 rounded-lg bg-gray-200 opacity-70">
                        <label
                            for="file-input"
                            class="flex items-center justify-center h-full border-dashed border-2 border-gray-400 rounded-lg">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    id="nama"
                                    name="nama"
                                    class="w-full p-2 border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500 rounded-lg"
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    name="berat"
                                    class="w-full p-2 border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500 rounded-lg"
                                    placeholder="Enter the cat's weight">
                            </div>
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    name="tinggi"
                                    class="w-full p-2 border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500 rounded-lg"
                                    placeholder="Enter the cat's height">
                            </div>
                            <div class="mb-4">
                                ...
                                <textarea
                                    ...
                                    name="deskripsi"
                                    class="w-full p-2 border border-gray-300 focus:outline-none focus:ring focus:ring-blue-500 rounded-lg"
                                    placeholder="Enter a description about the cat"></textarea>
                            </div>
                            <div>
                                <button
                                    class="bg-gray-500 text-white font-bold py-2 px-4 rounded-lg mt-2"
                                    type="reset">
                                    Clear All
                                </button>
                                <button
                                    class="bg-blue-500 hover:bg-green-500 text-white font-bold py-2 px-4 rounded-lg mt-2"
                                    type="submit">
                                    Save
                                </button>
                            </div>
